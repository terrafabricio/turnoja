...
const mockAvaliacoes = [
  { id: '1', company: 'Buffet Real', rating: 5, comment: 'Profissional excelente! Pontual, educado e muito eficiente. Recomendamos!', date: '2026-03-16' },
  { id: '2', company: 'Eventos Star', rating: 4, comment: 'Bom trabalho, cumpriu todas as tarefas. Voltaremos a contratar.', date: '2026-03-11' },
  { id: '3', company: 'Bar do Beco', rating: 5, comment: 'Ótimo barman, sabe trabalhar sob pressão. Clientes elogiaram os drinks.', date: '2026-02-21' },
  { id: '4', company: 'Hotel Premium', rating: 4, comment: 'Atendimento cordial e boa postura.', date: '2026-02-15' },
]

export default function AvaliacoesTrabPage() {
  const avg = mockAvaliacoes.reduce((s, r) => s + r.rating, 0) / mockAvaliacoes.length
          ...
          <Card key={av.id}>
            <CardContent className="pt-5">
              <div className="flex items-start gap-4">
                <Avatar><AvatarFallback>{av.company[0]}</AvatarFallback></Avatar>
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    <p className="font-medium text-foreground">{av.company}</p>
